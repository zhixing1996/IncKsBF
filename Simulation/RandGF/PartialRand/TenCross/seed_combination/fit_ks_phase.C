...
int main(int argc, char *argv[]){
	...
	TString apple="/besfs/groups/tauqcd/jingmq/IncKSBF/RandGF/PartialRand/TenCross/RootFile/fit_ks_phase";
	...
	ofstream paras;
	TString orange="/besfs/groups/tauqcd/jingmq/IncKSBF/RandGF/PartialRand/TenCross/Parameter/parameter";
	for (int i=1; i<argc;i++){
		orange+="_";
		orange+=argv[i];
	}
	...
	TString banana="/besfs/groups/tauqcd/jingmq/IncKSBF/RandGF/PartialRand/TenCross/CrossSection/cross_section";
	for (int i=1; i<argc;i++){
		banana+="_";
		banana+=argv[i];
	}
